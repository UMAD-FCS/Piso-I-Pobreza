...
ech22 <- ech22 %>% dplyr::mutate(bc_ipc_tot = case_when(
  mes == 1  ~ 0.310804203,
  mes == 2  ~ 0.305354401,
  mes == 3  ~ 0.300928439,
  mes == 4  ~ 0.297635795,
...
ech22 <- ech22 %>% dplyr::mutate(y_pc_d     =  (ht11 / HT19) * bc_ipc_tot)          #Ingreso per-cápita deflactado
ech22 <- ech22 %>% dplyr::mutate(y_pc_svl_d =  (ht11 - ht13) / HT19 * bc_ipc_tot) #Ingreso per-cápita sin valor locativo deflactado
...
ech22 <- ech22 %>% dplyr::mutate(quintilesy_obs = statar::xtile(y_pc, n=5, wt = w_ano))

# Decil de ingresos
ech22_h <- ech22 %>% distinct(ID, .keep_all = TRUE)
ech22_h <- ech22_h %>% dplyr::mutate(decilesy = statar::xtile(y_pc, n=10, wt = w_ano))
ech22_h <- ech22_h[,c("ID","decilesy")]
ech22 <- merge(ech22, ech22_h, by = "ID")

ech22 <- ech22 %>% dplyr::mutate(decilesy_obs = statar::xtile(y_pc, n=10, wt = w_ano))
...
ech22_h <- ech22 %>% distinct(ID, .keep_all = TRUE)
ech22_h <- ech22_h %>% dplyr::mutate(sexojefe = case_when(e30 == 1 & e26 == 1 ~ 1,
                                                        e30 == 1 & e26 == 2 ~ 2,
                                                        e30 != 1 ~ 99))
...
# NBI - Hacinamiento
ech22 <- ech22 %>% dplyr::mutate(aux1 = HT19/d9, 
                                 aux2 = HT19/d10,
                                 bd_hacinamiento1  = ifelse(aux1>2, 1, 0),
                                 bd_hacinamiento2  = ifelse(aux2>2, 1, 0))

# NBI - Materialidad vivienda
ech22 <- ech22 %>% dplyr::mutate(NBI_materialidad11 = ifelse(c2==6 | c3==6 | c4==5, 1, 0))


# NBI - Espacio apropiado para cocinar
ech22 <- ech22 %>% dplyr::mutate(bd_d19 = d19)
ech22 <- ech22 %>% dplyr::mutate(NBI_cocina11 = ifelse(bd_d19==3, 1, 0))


# NBI - Abastecimiento de agua potable
ech22 <- ech22 %>% dplyr::mutate(bd_d11 = case_when(d11==1 ~ 1, 
                                                    d11==2 | d11==3 ~ 2, 
                                                    d11>=4 & d11<=6 ~ 3))

ech22 <- ech22 %>% dplyr::mutate(bd_d12 = case_when(d12==1 ~ 1, 
                                 d12==2 | d12==3 ~ 2,
                                 d12==4 ~ 3))

ech22 <- ech22 %>% dplyr::mutate(NBI_agua11 = ifelse((bd_d12==2 | bd_d12==3) | bd_d11==3, 1, 0))



# NBI - Servicio higiénico de calidad
ech22 <- ech22 %>% dplyr::mutate(bd_d13 = as.numeric(d13))
ech22 <- ech22 %>% dplyr::mutate(bd_d14 = as.numeric(d14))
ech22 <- ech22 %>% dplyr::mutate(bd_d15 = as.numeric(d15))
ech22 <- ech22 %>% dplyr::mutate(bd_d16 = as.numeric(case_when(d16==0 ~ 0,
                                                               d16==1 ~ 1, 
                                                               d16==2 ~ 2, 
                                                               d16>=3 & d16<=4 ~ 3)))

ech22 <- ech22 %>% dplyr::mutate(NBI_servhigien11 = case_when(bd_d14==0 | bd_d15==2 | bd_d16==3 | bd_d16==4  ~ 1, 
                                                              bd_d14!=0 & bd_d15==1 & (bd_d16==1 | bd_d16==2)  ~ 0,
                                                              bd_d15==0 | bd_d16==0 ~ 99))

# NBI - Energía eléctrica
ech22 <- ech22 %>% dplyr::mutate(bd_d18 = d18)
ech22 <- ech22 %>% dplyr::mutate(NBI_energia11 = ifelse(bd_d18>2, 1, 0))


# NBI - Artefactos básicos de cofnort
ech22 <- ech22 %>% dplyr::mutate(bd_d260 = ifelse(d260 ==6, 2, 1))
ech22 <- ech22 %>% dplyr::mutate(bd_d21_1 = d21_3)
ech22 <- ech22 %>% dplyr::mutate(bd_d21_2 = case_when(d21_1==1 | d21_2==1 ~ 1,
                                                      d21_1==2 & d21_2==2 ~ 2))
                                                          

ech22 <- ech22 %>% dplyr::mutate(NBI_artefactos11 = ifelse(bd_d260==2 | bd_d21_1==2 | bd_d21_2==2, 1, 0))


# NBI - Educación

ech22 <- ech22 %>% dplyr::mutate(niños_na = case_when(
  e27<4 | e27>17 ~ 0,
...
base_niños_na <- ech22[,c("ID","niños_na")]
...
ech22 <- merge(ech22, base_niños_na, by = "ID")



# NBI Total

ech22 <- ech22 %>% dplyr::mutate(NBI_vivienda11= ifelse(bd_hacinamiento1==1 | NBI_materialidad11==1 | NBI_cocina11==1, 1, 0))
ech22 <- ech22 %>% dplyr::mutate(NBI_2011= ifelse(NBI_vivienda11==1 | NBI_agua11==1 | NBI_servhigien11==1 | NBI_energia11==1 | NBI_artefactos11==1 | NBI_educacion11==1, 1, 0))
                                                                                              
ech22 <- ech22 %>% dplyr::mutate(NBI_cant= NBI_vivienda11 + NBI_agua11 + NBI_servhigien11 + NBI_energia11 + NBI_artefactos11 + NBI_educacion11)
...
ech22_svy           <- srvyr::as_survey_design(ech22, ids = ID, weights = w_ano)
ech22_h_svy         <- srvyr::as_survey_design(ech22_h, ids = ID, weights = w_ano)
...
m134_pu <- c_decil_pu[10,1]/c_decil_pu[1,1]
m134_tp <- c_decil_tp[10,1]/c_decil_tp[1,1]
...
m135_pu <- c_quintil_pu[5,1]/c_quintil_pu[1,1]
m135_tp <- c_quintil_tp[5,1]/c_quintil_tp[1,1]
...
motor_2022 <- rbind(m111, m113, m121, m122, m123, m124, 
                    m132, m133, m134, 
                    m135, m141, m142, m145, m146 , m147, 
                    m148, m149, m150, m151, m152, m153, 
                    m154, m155, m156, m157, m158 )
motor_2022 <- as.data.frame(motor_2022)
motor_2022 <- motor_2022  %>% mutate(URBANORURALUY = case_when(PESTAÑA == "País Urbano"                                                                            ~ "Urbano (más de 5.000 habitantes)",
...
motor_2022 <- motor_2022  %>% mutate(CORTE = CORTE_NUEVA) 
...
Base_Motor_Pobreza_jul23  <- rbind(Base_Motor_Pobreza, motor_2022)

write.xlsx(Base_Motor_Pobreza_jul23, "Data/Base_Motor_Pobreza_JUL23.xlsx")

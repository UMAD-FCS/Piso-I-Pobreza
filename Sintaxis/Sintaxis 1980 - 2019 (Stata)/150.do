...
* INDICADOR: Porcentaje de personas residiendo en viviendas con paredes de desecho o techos de desecho o piso de tierra
* CÓDIGO:    150
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 150                  // Código de indicador
	...
	mean NBI_materialidad11 [aw=bc_pesoan]
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean NBI_materialidad11 [aw=bc_pesoan] if bd_region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `val'
	matrix MATR  [`i',3]=  `anio'
	local i  = `i' + 1
    ...
    *
	...
	mean NBI_materialidad11 [aw=bc_pesoan] if bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean NBI_materialidad11 [aw=bc_pesoan] if tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	13
	foreach val of numlist 1/2  {
	mean NBI_materialidad11 [aw=bc_pesoan] if bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean NBI_materialidad11 [aw=bc_pesoan] if bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean NBI_materialidad11 [aw=bc_pesoan] if pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 150
g NOMINDICADOR           = "PERSONAS RESIDIENDO EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PERSONAS DE 0 A 5 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"     if AUXILIAR==6
replace NOMINDICADOR    = "PERSONAS DE 6 A 12 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"    if AUXILIAR==7
replace NOMINDICADOR    = "PERSONAS DE 13 A 18 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"   if AUXILIAR==8
replace NOMINDICADOR    = "PERSONAS DE 19 A 24 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"   if AUXILIAR==9
replace NOMINDICADOR    = "PERSONAS DE 25 A 29 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"   if AUXILIAR==10
replace NOMINDICADOR    = "PERSONAS DE 30 A 64 AÑOS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"   if AUXILIAR==11
replace NOMINDICADOR    = "PERSONAS DE 65 AÑOS Y MÁS EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"  if AUXILIAR==12
...
replace NOMINDICADOR    = "PERSONAS NO EN SITUACIÓN DE POBREZA RESIDIENDO EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"         if AUXILIAR==20
replace NOMINDICADOR    = "PERSONAS EN SITUACIÓN DE POBREZA RESIDIENDO EN VIVIENDAS CON PAREDES O TECHOS DE DESECHO O PISO DE TIERRA (% DE LA POBLACIÓN TOTAL)"         if AUXILIAR==21

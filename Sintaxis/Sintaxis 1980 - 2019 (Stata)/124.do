...
* INDICADOR: Porcentaje de personas en situación de indigencia
* CÓDIGO:    124
* GRUPOS:    Región / Ascendencia étnico-racial / Sexo / Tramo de edad
* FUENTE:    ECH (INE)
* PERÍODO:   2006-2018
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 124                // Código de indicador
	...
	mean indigente06 [aw=bc_pesoan] if bd_region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `val'
	matrix MATR  [`i',3]=  `anio'
	local i  = `i' + 1
    ...
    *
	...
	mean indigente06 [aw=bc_pesoan] if bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean indigente06 [aw=bc_pesoan] if tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	13
	foreach val of numlist 1/2  {
	mean indigente06 [aw=bc_pesoan] if bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 124
g NOMINDICADOR           = "PERSONAS EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PERSONAS DE 0 A 5 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"    if AUXILIAR==6
replace NOMINDICADOR    = "PERSONAS DE 6 A 12 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"   if AUXILIAR==7
replace NOMINDICADOR    = "PERSONAS DE 13 A 18 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"  if AUXILIAR==8
replace NOMINDICADOR    = "PERSONAS DE 19 A 24 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"  if AUXILIAR==9
replace NOMINDICADOR    = "PERSONAS DE 25 A 29 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"  if AUXILIAR==10
replace NOMINDICADOR    = "PERSONAS DE 30 A 64 AÑOS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)"  if AUXILIAR==11
replace NOMINDICADOR    = "PERSONAS DE 65 AÑOS Y MÁS EN HOGARES EN SITUACIÓN DE INDIGENCIA (% DE LA POBLACIÓN TOTAL) (INE)" if AUXILIAR==12

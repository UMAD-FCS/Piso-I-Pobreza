...
* INDICADOR: Porcentaje de hogres con hacinamiento (CELADE) 
* CÓDIGO:    145
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 145                  // Código de indicador
	...
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1 & bd_region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `val'
	matrix MATR  [`i',3]=  `anio'
	local i  = `i' + 1
    ...
    *
	...
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *	
	...
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 145
g NOMINDICADOR           = "HOGARES CON HACINAMIENTO (% DE LA POBLACIÓN TOTAL) (Def. CELADE)"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "HOGARES NO EN SITUACIÓN DE POBREZA CON HACINAMIENTO (% DE LA POBLACIÓN TOTAL) (Def. CELADE)"      if AUXILIAR==9
replace NOMINDICADOR    = "HOGARES EN SITUACIÓN DE POBREZA CON HACINAMIENTO (% DE LA POBLACIÓN TOTAL) (Def. CELADE)"         if AUXILIAR==10
** 
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	local j  = 	1
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1 & bc_filtloc==1
 	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
	...
	local j  = 	4
	foreach val of numlist 1/5  {
	mean bd_hacinamiento_2 [aw=bc_pesoan] if bc_pe4==1 & bd_quintilesy==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'

...
* INDICADOR: Hogares sin artefactos básicos de confort
* CÓDIGO:    155
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 155                  // Código de indicador
	...
	mean NBI_artefactos11 [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean NBI_artefactos11 [aw=bc_pesoan] if bc_pe4==1 & bd_region==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `val'
	matrix MATR  [`i',3]=  `anio'
	local i  = `i' + 1
    ...
    *
	...
	mean NBI_artefactos11 [aw=bc_pesoan] if bc_pe4==1 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *	
	...
	mean NBI_artefactos11 [aw=bc_pesoan] if bc_pe4==1 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 155
g NOMINDICADOR           = "HOGARES SIN ARTEFACTOS BÁSICOS DE CONFORT(% DE LA POBLACIÓN TOTAL)"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "HOGARES NO EN SITUACIÓN DE POBREZA SIN ARTEFACTOS BÁSICOS DE CONFORT (% DE LA POBLACIÓN TOTAL)"      if AUXILIAR==9
replace NOMINDICADOR    = "HOGARES EN SITUACIÓN DE POBREZA SIN ARTEFACTOS BÁSICOS DE CONFORT (% DE LA POBLACIÓN TOTAL)"         if AUXILIAR==10
